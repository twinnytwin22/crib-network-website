...
function About() {
  return (
    <div className="h-[78vh] max-h-full mx-auto px-8">
      <div className="flex h-full items-center content-center overflow-y-scroll overflow-x-clip z-30 mx-auto wi">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-md md:max-w-7xl md:p-4 items-start md:items-center">
